...
function initShader() {
    ...
    const randomColor = flowersColors[Math.floor(Math.random() * flowersColors.length)];
    console.log(randomColor)
    const r = parseInt(randomColor.substring(1, 3), 16) / 255
    const g = parseInt(randomColor.substring(3, 5), 16) / 255
    const b = parseInt(randomColor.substring(5, 7), 16) / 255
    
    gl.uniform1f(uniforms.color_red, r);
    gl.uniform1f(uniforms.color_green, g);
    gl.uniform1f(uniforms.color_blue, b);
